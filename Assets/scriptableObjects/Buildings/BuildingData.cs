...
public class BuildingEffect
{
    ...
    public UnityEvent<BuildingObject, ICard, BuildingEffect> OnTrigger = new UnityEvent<BuildingObject, ICard,BuildingEffect>();
    ...
    public void Invoke(BuildingObject bO, ICard card)
    {
